...
package io.github.jinlongliao.easy.rc.core.compiler.impl.jdk;
 ...
 *
 * @author liaojinlong
 * @since 2020/9/11 17:10
 */
public class JdkCompiler extends AbstractJavaCompiler {
    ...
    public Class<?> doCompile(String name, String sourceCode) throws Throwable {
        ...
        Boolean result = compiler.getTask(null, javaFileManager, diagnosticCollector, options,
                null, Collections.singleton(javaFileObject)).call();
